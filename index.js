...
restService.post('/link', function(req, res) {
    var bodyJson = JSON.stringify(reg.body);
    ...
    var url = "http://smarthome2707.ddns.net/wapi/smartLinkDevice?deviceName="+deviceName+"&deviceAction=" + deviceAction +"&bodyJson=" + bodyJson   
